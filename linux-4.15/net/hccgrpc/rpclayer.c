...
inline int __rpc_send(struct rpc_desc* desc,
...
inline int __rpc_end_pack(struct rpc_desc* desc)
{
...
inline int __rpc_end_unpack(struct rpc_desc_recv* desc_recv)
{
...
inline int __rpc_end_unpack_clean(struct rpc_desc* desc)
{
	int i;
